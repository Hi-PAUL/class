...
<div  style="margin-top:18px;">    
  <div id="my_class" class="easyui-panel" title="你现在的位置   >> 相片墙" style="width:100%;height:500px;">
    <div id="toolbar" style="background:#F4F4F4">
        <a id="add_album" href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true">增加相册</a>
    </div>
    <!-- toolbar结束 -->
    
    <ul id="album_list">
       <li><a href="#"><img src="./images/icons/${user.cdkey}.jpg"><span>主题</span><span>著作</span></a></li>
